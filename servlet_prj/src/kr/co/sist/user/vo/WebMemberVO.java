...
public class WebMemberVO {
	private String id,pass,name,ssn,gender,brith,age,marriage,marriage_date,
		zipcode,addr1,addr2,greeting,ip_address;	
	private String[] lang;
	public WebMemberVO(String id, String pass, String name, String ssn, String gender, String brith, String age,
	...
	public String toString() {
		return "WebMemberVO [id=" + id + ", pass=" + pass + ", name=" + name + ", ssn=" + ssn + ", gender=" + gender
				+ ", brith=" + brith + ", age=" + age + ", marriage=" + marriage + ", marriage_date=" + marriage_date
