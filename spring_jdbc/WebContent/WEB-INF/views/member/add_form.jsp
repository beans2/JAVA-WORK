...
#header{  width:800px; height:140px; background: #FFFFFF url(http://localhost:8080/spring_jdbc/common/images/header_bg.png) repeat-x;
			position: relative;	}
...
<script type="text/javascript">
	$(function() {
		$("#upfile").change(function() {
			...
			//클라리언트의 파일은 보안 이슈 때문에 직접 접근하여 미리보기를 할 수 없다.
			/* var img=$("#img");
			img.src=upfile;
			alert(img.src) */
...
<div id="wrap">
	...
	<table>
		...
		<tr>
			<td rowspan="5">
				<img src="common/images/dafault.png" id="img" 
