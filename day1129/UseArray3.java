...
public class UseArray3 {
	...
	public UseArray3() {
		...
		System.out.println("arr배열의 면의 수: "+arr.length+", 행의 수: "+arr[0].length+", 열의수: "+arr[0][0].length);
		System.out.println("arr1배열의 면의 수: "+arr1.length+", 행의 수: "+arr1[0].length+", 열의수: "+arr1[0][0].length);
		//모든 방의 값 출력)
	...
	public void priType() {
		...
		int[][][] arr = {{{1,2,3},{4,5,6}},//0면
							{{7,8,9},{10,11,12}}}; //1면
		System.out.println("면의 수 :"+arr.length+", 행의수 :"+arr[0].length+",열의 수:"+arr[0][0].length);
