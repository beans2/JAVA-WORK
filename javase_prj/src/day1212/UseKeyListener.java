...
//	public static final int ESC=27;
	...
	public void keyTyped(KeyEvent ke) {
		// 2. 키가 눌려 정보가 전달되는 순간. 눌린 키의 정보 중 문자만 알 수 있다.
...
//		System.out.println("keyReleased");
		...
		int inputCode = ke.getKeyCode();//keycode는 키보드 키의 고유값:unicode와 다르게 같은 값이 나온다.
//		System.out.println(inputKey + " " + inputCode);
		// 출력Label에 뿌린다.
		StringBuilder output = new StringBuilder();
		output.append("눌린 키 문자: ").append(inputKey).append("  눌린 키의 키코드: ").append(inputCode);
