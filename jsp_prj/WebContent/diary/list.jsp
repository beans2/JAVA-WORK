...
<div id="wrap">
	...
	if(keyword!=null && !"".equals(keyword)){//사용자가 검색 값을 넣었을때
	...
	if(currentPage!=null){
		num= totalCount-(Integer.parseInt(currentPage)-1)*pageScale+1;
	}
...
<%-- 	전체 게시물 수: <%=totalCount%><br/>
	...
	<div id="diaryContents">
		...
		<tr>
			<td colspan="5">서비스가 원할하지 못한점 ㅈㅅ!</td>
		</tr>
		</c:if>
