          ...
          <ul>
            ...
            <li><a href="#void">2일차</a>
              <ul>
                ...
                <li><a href="view_modelandview.do" >ModelAndView 사용 데이터전달</a></li>
                <li><a href="use_redirect.do" >Redirect 이동</a></li>
              </ul>
            </li>
            <li><a href="#void">3일차</a>
              <ul>
                <li><a href="session/use_session.do" >HttpSession사용</a></li>
