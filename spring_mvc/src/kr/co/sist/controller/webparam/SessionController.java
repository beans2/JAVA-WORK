...
public class SessionController {
	...
	public String anSessionForm(HttpSession session) {
		...
		System.out.println("----------Controller anSessionForm 에서 받은 세션 값: =-------"
				+name+"/"+addr);
	...
	//입력되는 매개변수를 세션에 할당한다.
	//@SessionArrtibutes annotation을 사용하면 세션을 받지 않고 Model을 받는다.
