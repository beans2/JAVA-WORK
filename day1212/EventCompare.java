...
/**
 * 같은 종류의 이벤트가 여러개 발생하면, 그 이벤트를 비교하여 처리하는 방법 이벤트를 발생시킨 주소를 비교-모든 이벤트에서 사용가능 :
 * getSource()<br>
 * 이벤트를 발생시킨 객체의 Label을 비교 - ActionEvent에서만 사용가능: getActionCommend()
 * 
 * @author owner
 */
...
//		System.out.println("이벤트 발생 객체의 Label"+ ae.getActionCommand());
		...
		///////////////////////////// Lable
		///////////////////////////// 비교//////////////////////////////////////////////////////////////////////
		String lable = ae.getActionCommand();
		if (lable.equals("열기모드")) {
//			System.out.println("열기!!");
